...
public class TreeSetCompare{
	public static void main(String[] args) {
		...
		Iterator<Person> itr = heightWise.iterator();
		while(itr.hasNext()) {
		...
		weighttWise.add(P[3]);
		weighttWise.add(P[4]);
		System.out.println("Weight wise");
		Iterator<Person> itr2 = weighttWise.iterator();
		while(itr2.hasNext()) {
		...
		Iterator<Person> itr3 = nameWise.iterator();
		while(itr3.hasNext()) {
